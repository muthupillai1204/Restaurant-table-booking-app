...
class DrcrBill extends StatefulWidget {
  const DrcrBill({Key? key}) : super(key: key);

  @override
  State<DrcrBill> createState() => _DrcrBillState();
}

class _DrcrBillState extends State<DrcrBill> {
              ...
              showDialog(
                  ...
                  builder: (context) {
                    return const AlertDialog(
                      title: Text("Successfully booked and paid...!"),
                    );
                  });
            });
          },

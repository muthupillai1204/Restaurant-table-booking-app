...
class UpdateTables extends StatefulWidget {
  const UpdateTables({Key? key}) : super(key: key);
...
class _UpdateTablesState extends State<UpdateTables> {
  ...
  setVisiblitySeat() {
    setState(() {
      ...
      listSeatLeft[2]["isVisible"] = false; // left column index 2
      // listSeatLeft[3]["isVisible"] = false;
      listSeatRight[0]["isVisible"] = false; //right column index 0
      listSeatRight[1]["isVisible"] = false; // right column index 1
      listSeatRight[3]["isVisible"] = false; // right column index 3
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Update tables"),
              ...
              Row(
                ...
                children: [
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      foregroundColor: Colors.orange,
                      backgroundColor: const Color.fromARGB(255, 189, 126, 173),
                  ...
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      foregroundColor: Colors.orange,
                      backgroundColor: const Color.fromARGB(255, 112, 127, 196),
                      minimumSize: const Size(144, 50),
                      padding: const EdgeInsets.all(10.0),
                      shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(29.0)),
